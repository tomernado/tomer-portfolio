...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 px-5 border-t border-slate-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-14"
        >
          <p className="font-display text-blue-500 text-xs tracking-[0.3em] uppercase mb-2 font-semibold">Get in Touch</p>
          <h2 className="font-body font-extrabold text-4xl sm:text-5xl text-white">Contact</h2>
          <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-14 lg:gap-20">
          ...
          >
            <motion.div variants={fadeUp}>
              <h2 className="font-body font-extrabold text-3xl sm:text-4xl text-white leading-snug mb-3">
                Let's build<br />
                <span className="text-blue-400">something together.</span>
              </h2>
              <p className="font-body text-slate-400 text-sm leading-relaxed max-w-xs">
                Open to new opportunities, challenging projects, and interesting collaborations.
              </p>
            </motion.div>
          ...
          >
            <div className="flex items-center gap-2.5 mb-6">
              ...
              <p className="font-body font-semibold text-white text-lg">Send a WhatsApp message</p>
            </div>
