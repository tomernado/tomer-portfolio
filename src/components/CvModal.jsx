        ...
        <div className="sm:hidden flex-1 flex flex-col items-center justify-center gap-6 p-8 text-center">
          ...
          <div className="flex flex-col gap-3 w-full max-w-xs">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 px-5 py-3.5 bg-white hover:bg-white/90 active:scale-95 text-black rounded-xl font-semibold text-sm transition-all duration-200"
            >
            ...
            <a
              href={personalInfo.cvPdf}
              download="Tomer_Cohen_Resume.pdf"
              className="flex items-center justify-center gap-2 px-5 py-3.5 bg-white/8 hover:bg-white/15 active:scale-95 text-white rounded-xl font-semibold text-sm transition-all duration-200"
            >
              <Download size={16} />
              הורד PDF
            </a>
