...
export const personalInfo = {
  ...
  aboutText:
    "שמי תומר כהן, סטודנט שנה ג' למדעי המחשב ב-HIT ומפתח Software Engineering המשלב ידע מעמיק בארכיטקטורת Full-Stack (React, Java, C#) עם דגש חזק על עקרונות OOP, S-SDLC, ו-Clean Code. אני מביא איתי רקע מוכח בניהול אופרציות מורכבות תחת לחץ, ניהול צוותים ופתרון משברים טכנולוגיים ולוגיסטיים. אני מתמחה בבניית פתרונות תוכנה מאובטחים מקצה לקצה תוך שימוש מתקדם בכלי בינה מלאכותית להאצת הפיתוח. מחפש את האתגר הבא שלי בתפקיד פיתוח מאתגר שבו אוכל להביא לידי ביטוי את הסקרנות והמקצועיות שלי.",
};
